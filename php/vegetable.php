<?php
  ...
  $query = "SELECT productId, productName, productPrice FROM Product WHERE productTypeId = 1;";
...
<html lang="en">
  ...
  <div class="container" style="margin-top:30px">
    <h1><class="head"><strong>Vegetable</strong></h1><br><br>
    <nav class="navbar navbar-expand-sm bg-light">
    <ul>
    <li><a href="../php/home.php">Home</a></li>
    <li><a href="../php/product.php">All product</a></li>
    <li><a class="active" href="../php/vegetable.php">Vegetable</a></li>
